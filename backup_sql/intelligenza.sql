...
(1, '', 1, '2020-03-05 21:13:08', 'Administrator', '', '', '', '', '', '', '', '', 'no', '', 'no', 'no', 'yes', 'no', 'no', 'no', 'yes', 'no', 'yes', 'no', 'no', 'yes', 'yes', 'no', 'no', 'yes', 'no', 'no', 'no', 'no', 'no', 'no', '', 'no', '', '', '', 'no', '', 'ru', '', '', '');
...
--
ALTER TABLE `site_noty`
  MODIFY `idNoty` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

...
<head>
	<meta charset="utf-8" />
	<title><?php echo($app_nameProject);?> | Gathering Events</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed fade">
		...
		<div id="content" class="content">
			...
			<ul class="breadcrumb">
				...
				<li class="breadcrumb-item active">Gathering Events</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			<h1 class="page-header">
				Events <small>parties, private in your circle or public...</small>
			</h1>
			<!-- END page-header -->
			<p>
				work in progress

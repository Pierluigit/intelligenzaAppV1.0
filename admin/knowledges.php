...
if($app_ifMembersUseKnowledges!="yes") {
...
<head>
	<meta charset="utf-8" />
	<title><?php echo($app_nameProject);?> | Knowledges</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed fade">
		...
		<div id="content" class="content">
			...
			<h1 class="page-header">
				My knowledges <small>Tutos, Languages...</small>
			</h1>
			<!-- END page-header -->
			<p>
				ADD infos work in progress<br>
				<img src="../img/languages-white.png" width="88" height="88" alt=""/>
				<img src="../img/note-white.png" width="88" height="88" alt=""/>
				
				<img src="../img/email-white.png" width="88" height="88" alt=""/>
				<img src="../img/pdf-white.png" width="101" height="101" alt=""/>
				<img src="../img/internet-white.png" width="88" height="88" alt=""/>
				<img src="../img/phone-white.png" width="88" height="88" alt=""/>
				<img src="../img/idea-white.png" width="88" height="88" alt=""/>
				<img src="../img/movie-white.png" width="88" height="88" alt=""/>
				
				<img src="../img/voice-recorder-white.png" width="88" height="88" alt=""/>
				<img src="../img/code-white.png" width="88" height="88" alt=""/>
				
				<img src="../img/add-white.png" width="88" height="88" alt=""/>
			</p>
		</div>
		<!-- END #content -->

...
<head>
	<meta charset="utf-8" />
	<title><?php echo($app_nameProject);?> | Gathering People</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed fade">
		...
		<div id="content" class="content bgBoxApp">
			...
			<ul class="breadcrumb">
				...
				<li class="breadcrumb-item active">Gathering People</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			<h1 class="page-header">
				Gathering People <small>page header description goes here...</small>
			</h1>
			<!-- END page-header -->
			<p>

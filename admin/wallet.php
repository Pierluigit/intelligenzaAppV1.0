...
<head>
	<meta charset="utf-8" />
	<title><?php echo($app_nameProject);?> | Wallet</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed fade">
		...
		<div id="content" class="content">
			...
			<h1 class="page-header">
				Wallet <small>work in progress...</small>
			</h1>
			<!-- END page-header -->
			<p>
				New Device New Money!<br><br>
				Time is money, you can do commerce and pay with time of work or services, it respects in any cases, the real value of the deal!
			</p>
		</div>
		<!-- END #content -->

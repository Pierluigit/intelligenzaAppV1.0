...
///////////////////////////////////////////
///////////////////////////////////////////
// Title: Gathering Social Circles
...
$page = "app_gatheringSocialCircles";
//////////////////////////////////////////
//////////////////////////////////////////
...
<head>
	<meta charset="utf-8" />
	<title><?php echo($app_nameProject);?> | Gathering Social Circles</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed fade">
		...
		<div id="content" class="content bgBoxApp">
			...
			<ul class="breadcrumb">
				...
				<li class="breadcrumb-item active">Gathering Social Circles</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			<h1 class="page-header">
				Local Circles <small>who do you are connected with...</small>
			</h1>
			<!-- END page-header -->
			<p>
				work in progress

...
<a href=""><img src="../img/voir-white.png" width="<?php echo($size);?>" height="<?php echo($size);?>" title="Show Profile" alt=""/></a>
...
<?php if(($phonePersoMember!="") && ($ifShowPhonePerso=="yes")) {?>
...
<a href="tel:<?php echo($phonePersoMember);?>"><img src="../img/phone-white.png" width="<?php echo($size);?>" height="<?php echo($size);?>" title="Pro: <?php echo($phonePersoMember);?>" alt=""/></a>
<?php }?>

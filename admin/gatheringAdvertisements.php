...
///////////////////////////////////////////
///////////////////////////////////////////
// Title: Gathering Advertisements
...
$page = "app_gatheringAdvertisements";
//////////////////////////////////////////
//////////////////////////////////////////
...
<head>
	<meta charset="utf-8" />
	<title><?php echo($app_nameProject);?> | Gathering Advertisements</title>
	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed fade">
		...
		<div id="content" class="content bgBoxApp">
			...
			<ul class="breadcrumb">
				...
				<li class="breadcrumb-item active">Gathering Advertisements</li>
			</ul>
			<!-- END breadcrumb -->
			<!-- BEGIN page-header -->
			<h1 class="page-header">
				Advertisements <small>job, land, sell, buy...</small>
			</h1>
			<!-- END page-header -->
			<p>
				work in progress

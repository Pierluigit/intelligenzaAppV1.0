	...
	<div id="page-container" class="page-header-fixed page-sidebar-fixed fade">
		...
		<div id="content" class="content">
			...
			<h1 class="page-header">
				Dashboard <small>work in progress...</small>
			</h1>
			<!-- BEGIN row -->
			<div class="row">
				<!-- BEGIN col-6 -->
				<div class="col-lg-6 col-sm-12">
					...
					<div class="widget widget-card widget-card-rowspan2 dynamic-xs inverse-mode with-min-height">
						...
						<div class="widget-card-content">
							<a href="noty.php" class="widget-title-link bg-primary">Notifcation</a>
							...
							<div class="row">
								...
								<div class="col-6">
									...
									<ul class="widget widget-list m-b-0 no-bg inverse-mode">
										<li>
											<!-- BEGIN widget-list-container -->
											<a href="knowledges.php" class="widget-list-container">
												<div class="widget-list-media icon p-l-0">
													<i class="fas fa-graduation-cap bg-theme"></i>
													
												</div>
												<div class="widget-list-content">
													<h4 class="widget-title">Knowleges</h4>
													<div class="widget-desc hidden-xs">My Brain</div>
												</div>
											</a>
											<!-- END widget-list-container -->
										</li>
										<li>
											<!-- BEGIN widget-list-container -->
											<a href="profile.php" class="widget-list-container">
												<div class="widget-list-media icon p-l-0">
													<i class="ti-user bg-gradient-red"></i>
												</div>
												<div class="widget-list-content">
													<h4 class="widget-title">Profile</h4>
													<div class="widget-desc hidden-xs">Posts, Photo, video...</div>
												</div>
											</a>
											<!-- END widget-list-container -->
										</li>
										<li>
											<!-- BEGIN widget-list-container -->
											<a href="helper.php" class="widget-list-container">
												<div class="widget-list-media icon p-l-0">
													
													<i class="ti-help-alt bg-gradient-orange"></i>
													
												</div>
												<div class="widget-list-content">
													<h4 class="widget-title">Helper</h4>
													<div class="widget-desc hidden-xs">Tuto video</div>
												</div>
											</a>
											<!-- END widget-list-container -->
										</li>
					...
					<div class="widget widget-card inverse-mode with-min-height">
						...
						<div class="widget-card-content bottom">
							<div class="widget-card-img bg-gradient-blue">
								<img src="../images/logo/intel/logo_noty_intelligenza.png" alt="" />
							</div>
				...
				<div class="col-lg-3 col-sm-6">
					...
					<div class="widget widget-card inverse-mode with-min-height">
						...
						<div class="widget-card-content bottom">
							...
							<div class="widget-card-info">
								<h4 class="widget-title">Color your life enjoy others people</h4>
								<ul class="widget-inline-list">
									<li>129 parties</li>
									<li>1,382 friends</li>
								</ul>
